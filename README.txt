Ionic 3 Core Professional Edition 1.20 README
================================================

Thank you for downloading Ionic 3 Core as part of Ionic 3 Toolkit Professional Edition distribution.

Ionic 3 Core distribution includes the source code of a full working Cordova/Ionic 
project. It's ready to run (almost) out the box.

Overview
--------

Specifically, this pack consists of the following two
directories:
...
------------------------
Quick start guide
https://docs.google.com/document/d/1Wr4_HhlAsuonR_shMnNbNWoVBjaJxA3OexfIw4Tdtw8/edit?usp=sharing
