...
import { ConsultModifyPrefilePage } from '../pages/consult-modify-prefile/consult-modify-prefile';
...
export class MyApp {
	...
	constructor(platform: Platform, menu: MenuController, oauthService: OAuthService, private statusBar: StatusBar) {
		...
		this.homePage = { title: 'Home', component: HomePage, icon: 'home' };
         this.formalizationPages=[

			{ title: 'Consult/Modify Prefile', component: ConsultModifyPrefilePage, icon: 'swap' },
